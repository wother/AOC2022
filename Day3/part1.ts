...
export function findSharedCharacters(
  inputOne: string,
  inputTwo: string
): string | "" {
  //   NOTE: This finds the LAST character in the first input that both share.
...
// Score Characters
export function scorePriority(input: string): number {
